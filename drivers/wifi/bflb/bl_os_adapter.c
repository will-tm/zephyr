...
static __attribute__((unused)) int bl_os_task_notify_isr_impl(BL_TaskHandle_t task_handle);
static __attribute__((unused)) void bl_os_yield_from_isr_impl(int xYield);
static __attribute__((unused)) unsigned int bl_os_ms_to_tick_impl(unsigned int ms);
static __attribute__((unused)) BL_TimeOut_t bl_os_set_timeout_impl(void);
static __attribute__((unused)) int bl_os_check_timeout_impl(BL_TimeOut_t xTimeOut,
							    BL_TickType_t *xTicksToWait);
