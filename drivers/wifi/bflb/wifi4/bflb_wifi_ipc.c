 ...
 * doorbell trigger differ between the BL602 and BL606P/BL808 blobs and live
 * in the per-SoC soc/bflb/<series>/wifi/bflb_wifi_blob.c files.
 */
...
int bflb_wifi_ipc_init(struct bflb_wifi_dev *d)
{
	...
	IRQ_CONNECT(WIFI_IPC_IRQ_NUM, WIFI_IPC_IRQ_PRI, bflb_wifi_blob_ipc_isr, NULL, 0);
