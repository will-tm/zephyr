...
static void release_d0_core(void)
{
	 ...
	 * M0's XIP base is 0x58000000 with SF_ID0 offset 0x2000.
	 * D0's image is at flash offset D0_FLASH_OFFSET + 0x2000.
	 * From M0's XIP view: 0x58000000 + D0_FLASH_OFFSET = 0x58100000 */
